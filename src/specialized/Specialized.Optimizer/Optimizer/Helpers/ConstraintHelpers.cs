...
namespace Specialized.Optimizer.Optimizer.Helpers
{
    ...
    {
        public static (int Hard, int Soft) CalculateConstraintScore(this PlanningDomain domain)
        {
            var hcScore =
                ...
                + 0; //hc9
            var scScore = 
                -1 * 1000 * domain.SC1_TotalPriorityConstraint
                + 1250 * domain.SC2_TotalConstraint
